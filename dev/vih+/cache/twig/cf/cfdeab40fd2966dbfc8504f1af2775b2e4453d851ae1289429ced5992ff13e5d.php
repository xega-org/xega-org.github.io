...
class __TwigTemplate_edd683ab05ca3d3d3e6f91e724d99f58d90658c87527b75205a916d2b18a1cf2 extends Twig_Template
{
...
";
    ...
    <div class=\"switch-toggle switch-grav ";
        ...
        foreach ($context['_seq'] as $context["key"] => $context["text"]) {
            ...
            // line 34
            echo "            ";
            $context["translation"] = twig_trim_filter((($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "twig", array(), "any", false, true), "twig", array(), "any", false, true), "filters", array(), "any", false, true), "tu", array(), "array", true, true)) ? ($this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter($context["text"])) : ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate($context["text"]))));
            // line 35
            echo "
            <input type=\"radio\"
                value=\"";
...
";
    ...
    {
        return new Twig_Source("", "forms/fields/toggle/toggle.html.twig", "/home/xegaorhd/public_html/_apps/vih+/user/plugins/admin/themes/grav/templates/forms/fields/toggle/toggle.html.twig");
    }
}
