...
<h1>
    ";
        // line 4
        echo (((isset($context["installing"]) ? $context["installing"] : null)) ? ($this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.AVAILABLE_THEMES")) : ($this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.INSTALLED_THEMES")));
        echo "
</h1>
    ...
    ";
        ...
        <div class=\"theme card-item pure-u-1-3 ";
            ...
            if ($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "isTeamGrav", array(0 => $context["theme"]), "method")) {
                ...
                echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.GRAV_OFFICIAL_THEME");
                echo "\"></i></span></small>
                ";
            }
            // line 20
            ...
            if ($this->getAttribute($context["theme"], "symlink", array())) {
                ...
                echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.THEME_SYMBOLICALLY_LINKED");
                echo "\">
            ...
            if (((isset($context["state"]) ? $context["state"] : null) == "installing")) {
                ...
                echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.INSTALL");
                echo "</a>
                </div>
            ";
            } elseif ((            // line 35
(isset($context["state"]) ? $context["state"] : null) == "active")) {
                ...
                // line 37
                echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.ACTIVE_THEME");
                echo "
                </div>
            ";
            } else {
                ...
                echo "\" class=\"gpm-actions\">
                    ";
                // line 41
                echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.ACTIVATE");
                echo "
                </a>
            ";
            }
...
<div class=\"remodal theme-switcher\" data-remodal-id=\"theme-switch-warn\" data-remodal-options=\"hashTracking: false\">
    <form>
        <h1>";
        // line 52
        echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.SWITCHING_TO");
        echo " <strong>{theme_name}</strong></h1>
        <p class=\"bigger\">
            ";
        // line 54
        echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.SWITCHING_TO_DESCRIPTION");
        echo "
        </p>
        <p class=\"bigger\">
            ";
        // line 57
        echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.SWITCHING_TO_CONFIRMATION");
        ...
        // line 61
        echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.CANCEL");
        echo "</a>
            <a class=\"button continue\" href=\"#\"><i class=\"fa fa-fw fa-check\"></i>";
        // line 62
        echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.CONTINUE");
        echo "</a>
        </div>
    </form>
</div>
...
", "partials/themes-list.html.twig", "/home/xegaorhd/public_html/_apps/orgullo/2016/user/plugins/admin/themes/grav/templates/partials/themes-list.html.twig");
    }
}
