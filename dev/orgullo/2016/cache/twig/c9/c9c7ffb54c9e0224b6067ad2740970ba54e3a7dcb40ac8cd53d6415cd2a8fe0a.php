...
class __TwigTemplate_c2fb21550f1e19dae6e3314c912fb2d911ce272be8e46f1fa103ca1d233072f4 extends Twig_Template
{
  ...
  <a class=\"jp-relatedposts-post-a\" href=\"";
    ...
    ";
                ...
                if (twig_first($this->env, $this->getAttribute($this->getAttribute((isset($context["related"]) ? $context["related"] : null), "media", array()), "images", array()))) {
                    // line 7
                    echo "    ";
                    echo $this->getAttribute($this->getAttribute(twig_first($this->env, $this->getAttribute($this->getAttribute((isset($context["related"]) ? $context["related"] : null), "media", array()), "images", array())), "cropZoom", array(0 => 218, 1 => 125), "method"), "html", array(0 => "", 1 => "", 2 => "jp-relatedposts-post-img"), "method");
                    echo "
    ";
                }
                // line 9
...
{% endif %}
{% endfor %}
", "partials/relatedpages.html.twig", "/home/xegaorhd/public_html/_apps/orgullo/2016/user/themes/receptar-xega/templates/partials/relatedpages.html.twig");
    }
}
