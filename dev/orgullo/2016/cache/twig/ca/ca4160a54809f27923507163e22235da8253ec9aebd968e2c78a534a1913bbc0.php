...
class __TwigTemplate_bd1b8e1b165b31bbcdba355b3d310fc01713370d60d521823905cf025d10f775 extends Twig_Template
{
  ...
  <div class=\"entry-inner\">
    <div class=\"entry-inner";
      ...
      ";
        ...
        ";
            // line 42
            if ($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "when", array())) {
                // line 43
                echo "          <span class=\"entry-meta-element\">
            <i class=\"fa fa-clock-o fa-fw\" aria-hidden=\"true\"></i> ";
                // line 44
                echo $this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "when", array());
                echo "
          </span>
        ";
            }
            // line 47
            echo "        ";
            if ($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "where", array())) {
                // line 48
                echo "          <span class=\"entry-meta-element\">
            <i class=\"fa fa-map-marker fa-fw\" aria-hidden=\"true\"></i> ";
                // line 49
                echo $this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "where", array());
                echo "
          </span>
        ";
            }
            // line 52
            echo "        ";
            if ($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "accessible", array())) {
                // line 53
                echo "          <span class=\"entry-meta-element\">
            <i class=\"fa fa-wheelchair-alt fa-fw\" aria-hidden=\"true\"></i> ";
                // line 54
                echo $this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "accessible", array());
                echo "
          </span>
        ";
            }
            // line 57
            echo "        ";
            if ($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "signlang", array())) {
                // line 58
                echo "          <span class=\"entry-meta-element\">
            <i class=\"fa fa-american-sign-language-interpreting fa-fw\" aria-hidden=\"true\"></i> ";
                // line 59
                echo $this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "signlang", array());
                echo "
          </span>
        ";
            }
            // line 62
            echo "        ";
            if ($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "subtitles", array())) {
                // line 63
                echo "          <span class=\"entry-meta-element\">
            <i class=\"fa fa-deaf fa-fw\" aria-hidden=\"true\"></i> ";
                // line 64
                echo $this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "subtitles", array());
                echo "
          </span>
        ";
            }
...
($context["truncate"] ?? null)) {
      ...
      ";
        ...
        <div class=\"comments-area\">
          ...
          ";
                // line 235
                $this->loadTemplate("partials/comments.html.twig", "partials/blog_item.html.twig", 235)->display(array_merge($context, array("page" => ($context["page"] ?? null))));
                // line 236
                echo "        </div>
      </div>
      ";
...
", "partials/blog_item.html.twig", "C:\\Users\\Miguel\\Documents\\github.com\\xega-org\\xega-org.github.io\\dev\\orgullo\\2016\\user\\themes\\receptar-xega\\templates\\partials\\blog_item.html.twig");
    }
}
