...
class __TwigTemplate_6fd452ceb08daa2d44af5a42fac0503b7902466c631a15c0b68d0cafd04605b2 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "route", array())) {
            // line 4
            $context["installing"] = (is_string($__internal_7fc5c416a15cfdf54a3458c16cc670b58f71afa95eb9b8056a5bd00fb4833808 = $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "route", array())) && is_string($__internal_f359b9a4db64f8386dd828a23d969ef1abffbfb8797b39894d8130c9ce6b958a = "install") && ('' === $__internal_f359b9a4db64f8386dd828a23d969ef1abffbfb8797b39894d8130c9ce6b958a || 0 === strpos($__internal_7fc5c416a15cfdf54a3458c16cc670b58f71afa95eb9b8056a5bd00fb4833808, $__internal_f359b9a4db64f8386dd828a23d969ef1abffbfb8797b39894d8130c9ce6b958a)));
            // line 5
    ...
    public function block_titlebar($context, array $blocks = array())
    {
        ...
        ";
            ...
            if ((isset($context["installing"]) ? $context["installing"] : null)) {
                ...
                echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.BACK");
                echo "</a>
        ";
            } else {
                // line 39
            ...
            <a class=\"button\" href=\"";
                ...
                echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.ADD");
                echo "</a>
            ";
                // line 41
                if ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->authorize(array(0 => "admin.maintenance", 1 => "admin.super"))) {
                    ...
                    echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.CHECK_FOR_UPDATES");
                    echo "</button>
            ";
                }
                // line 44
        ...
        <h1><i class=\"fa fa-fw fa-tint\"></i> ";
            // line 46
            echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.THEMES");
            echo "</h1>
    ";
        } else {
            // line 48
            ...
            <a class=\"button\" href=\"";
                ...
                echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.BACK_TO_THEMES");
                echo "</a>
            <button class=\"button\" type=\"submit\" name=\"task\" value=\"save\" form=\"blueprints\"><i class=\"fa fa-check\"></i> ";
                // line 51
                echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.SAVE");
                echo "</button>
        </div>
        ";
            } else {
        ...
        ";
            ...
            echo $this->env->getExtension('Grav\Plugin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.THEME");
            echo ": ";
...
{% endblock %}
", "themes.html.twig", "/home/xegaorhd/public_html/_apps/orgullo/2016/user/plugins/admin/themes/grav/templates/themes.html.twig");
    }
}
